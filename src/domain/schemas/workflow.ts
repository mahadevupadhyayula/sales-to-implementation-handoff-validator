...
export const findingSchema = z.object({
  ...
  category: z.enum(["scope", "timeline", "integration", "security", "resourcing", "commercial", "governance", "data"]),
...
export const approvedBaselineOutputSchema = z.object({
  ...
  baseline: z.object({ scope: z.array(nonEmptyTextSchema), assumptions: z.array(nonEmptyTextSchema), unresolvedItems: z.array(nonEmptyTextSchema), workstreams: z.array(workstreamReadinessSchema) }),
});
