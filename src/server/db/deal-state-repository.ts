...
function insertPayload(database: DatabaseSync, table: string, columns: string[], values: unknown[], record: RecordWithId): void {
...
function insertCitations(database: DatabaseSync, kind: "fact" | "finding" | "readiness", ownerId: string, citations: Citation[]): void {
...
export function replaceDealState(database: DatabaseSync, input: unknown): NormalizedDealState {
...
function readPayloads(database: DatabaseSync, table: string, dealId: string): unknown[] {
...
export function readDealState(database: DatabaseSync, dealId: string): NormalizedDealState {
